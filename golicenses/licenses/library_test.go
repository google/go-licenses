...
func TestLibraries(t *testing.T) {
	...
	for _, test := range []struct {
	...
	}{
		{
			...
			importPath: "github.com/khulnasoft/go-licenses/golicenses/licenses/testdata/direct",
			wantLibs: []string{
				"github.com/khulnasoft/go-licenses/golicenses/licenses/testdata/direct",
				"github.com/khulnasoft/go-licenses/golicenses/licenses/testdata/indirect",
			},
		},
		{
			desc:       "Detects transitive dependency",
			importPath: "github.com/khulnasoft/go-licenses/golicenses/licenses/testdata",
			wantLibs: []string{
				"github.com/khulnasoft/go-licenses/golicenses/licenses/testdata",
				"github.com/khulnasoft/go-licenses/golicenses/licenses/testdata/direct",
				"github.com/khulnasoft/go-licenses/golicenses/licenses/testdata/indirect",
			},
		},
		{
			...
			importPath: "github.com/khulnasoft/go-licenses/golicenses/licenses/testdata/tags",
			goflags:    "-tags=tags",
			wantLibs: []string{
				"github.com/khulnasoft/go-licenses/golicenses/licenses/testdata/tags",
				"github.com/khulnasoft/go-licenses/golicenses/licenses/testdata/indirect",
			},
		},
	} {
