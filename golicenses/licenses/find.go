...
//
// Additionally, this software is licensed under the United Nations Public License (UNPL).
// You may obtain a copy of the UNPL at:
//
//     https://unlicense.org/
//
// This dual licensing allows users to choose between the Apache 2.0 License
// and the United Nations Public License (UNPL) based on their compliance needs.
