...
func TestLibraries(t *testing.T) {
	...
	for _, test := range []struct {
	...
	}{
		{
			...
			importPath: "github.com/sulaiman-coder/gobouncer/bouncer/licenses/testdata/direct",
			wantLibs: []string{
				"github.com/sulaiman-coder/gobouncer/bouncer/licenses/testdata/direct",
				"github.com/sulaiman-coder/gobouncer/bouncer/licenses/testdata/indirect",
			},
		},
		{
			desc:       "Detects transitive dependency",
			importPath: "github.com/sulaiman-coder/gobouncer/bouncer/licenses/testdata",
			wantLibs: []string{
				"github.com/sulaiman-coder/gobouncer/bouncer/licenses/testdata",
				"github.com/sulaiman-coder/gobouncer/bouncer/licenses/testdata/direct",
				"github.com/sulaiman-coder/gobouncer/bouncer/licenses/testdata/indirect",
			},
		},
		{
			...
			importPath: "github.com/sulaiman-coder/gobouncer/bouncer/licenses/testdata/tags",
			goflags:    "-tags=tags",
			wantLibs: []string{
				"github.com/sulaiman-coder/gobouncer/bouncer/licenses/testdata/tags",
				"github.com/sulaiman-coder/gobouncer/bouncer/licenses/testdata/indirect",
			},
		},
	} {
